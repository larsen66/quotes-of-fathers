...
* **TR-2.1:** Админ-панель реализуется на базе **Retool** (или совместимого low-code инструмента).
* **TR-2.2:** Админ-панель подключается напрямую к Firestore и Firebase Storage.
* **TR-2.3:** Деплой и администрирование инфраструктуры осуществляется владельцем проекта.
